...
# Cómo se comprueba de verdad
    ...
    Tools/agentes/unity.sh PlayMode costura

Y el guion que ya existe y cuenta las referencias por nombre de un lado a otro — pásalo
antes de tocar nada, para saber de qué parte vienes:

    python3 Informes/costura_nombres.py
